...
static void (*prov_giving_up_callback)(void);

void mesh_prov_giving_up_callback_register(void (*handler)(void))
{
    prov_giving_up_callback = handler;
}
...
static void prov_retransmit(struct k_work *work)
{
    ...
    if (k_uptime_get() - link.tx.start > timeout) {
        ...
        reset_adv_link();
        if (prov_giving_up_callback) {
            /* prov_giving_up_callback(); */
        }
        return;
    }

...
#define GUEST_SERVICE
#ifdef GUEST_SERVICE
#define ATT_CHARACTERISTIC_FFF1_01_VALUE_HANDLE 0x92
#define ATT_CHARACTERISTIC_FFF1_01_CLIENT_CONFIGURATION_HANDLE 0x93
#define ATT_CHARACTERISTIC_FFF2_01_VALUE_HANDLE 0x95
#define ATT_CHARACTERISTIC_FFF3_01_VALUE_HANDLE 0x97
#endif
...
//  len-------------------------Properties----  Handle--------------------------UUID16----------Value------------------------------------
    ...
    //////////////////////////////////////////////////////
    //
    // 0x0090 PRIMARY_SERVICE  FFF0
    //
    //////////////////////////////////////////////////////
    0x0a, 0x00, 0x02, 0x00, 0x90, 0x00, 0x00, 0x28, 0xf0, 0xff,

    /* CHARACTERISTIC,  FFF1, NOTIFY | READ |DYNAMIC, */
    // 0x0002 CHARACTERISTIC FFF1 NOTIFY | READ |DYNAMIC
    0x0d, 0x00, 0x02, 0x00, 0x91, 0x00, 0x03, 0x28, 0x12, ATT_CHARACTERISTIC_FFF1_01_VALUE_HANDLE, 0x00, 0xf1, 0xff,
    // 0x0003 VALUE FFF1 NOTIFY | READ |DYNAMIC
    0x08, 0x00, 0x12, 0x01, ATT_CHARACTERISTIC_FFF1_01_VALUE_HANDLE, 0x00, 0xf1, 0xff,
    // 0x0004 CLIENT_CHARACTERISTIC_CONFIGURATION
    0x0a, 0x00, 0x0a, 0x01, ATT_CHARACTERISTIC_FFF1_01_CLIENT_CONFIGURATION_HANDLE, 0x00, 0x02, 0x29, 0x00, 0x00,

    /* CHARACTERISTIC,  FFF2, READ | WRITE | DYNAMIC, */
    // 0x0005 CHARACTERISTIC FFF2 READ | WRITE | DYNAMIC
    0x0d, 0x00, 0x02, 0x00, 0x94, 0x00, 0x03, 0x28, 0x0a, ATT_CHARACTERISTIC_FFF2_01_VALUE_HANDLE, 0x00, 0xf2, 0xff,
    // 0x0006 VALUE FFF2 READ | WRITE | DYNAMIC
    0x08, 0x00, 0x0a, 0x01, ATT_CHARACTERISTIC_FFF2_01_VALUE_HANDLE, 0x00, 0xf2, 0xff,

    /* CHARACTERISTIC,  FFF3, READ | WRITE | DYNAMIC, */
    // 0x0007 CHARACTERISTIC FFF3 READ | WRITE | DYNAMIC
    0x0d, 0x00, 0x02, 0x00, 0x96, 0x00, 0x03, 0x28, 0x0a, ATT_CHARACTERISTIC_FFF3_01_VALUE_HANDLE, 0x00, 0xf3, 0xff,
    // 0x0008 VALUE FFF3 READ | WRITE | DYNAMIC
    0x08, 0x00, 0x0a, 0x01, ATT_CHARACTERISTIC_FFF3_01_VALUE_HANDLE, 0x00, 0xf3, 0xff,
#endif
...
//  len-------------------------Properties----  Handle--------------------------UUID16----------Value------------------------------------
    ...
    13, 0x00,                    0x02, 0x00,    0x02, 0x00,                     0x03, 0x28,     0x02, 0x03, 0x00, 0x00, 0x2A,                   //characteristic declaration
//    8 + BLE_DEV_NAME_LEN, 0x00,  0x02, 0x00,    0x03, 0x00,                     0x00, 0x2A,     BLE_DEV_NAME,                                   //device name
    8, 0x00, 0x02, 0x01, 0x03, 0x00, 0x00, 0x2A,
    ///--Primary Service Declaration:Generic Attribute
    10, 0x00,                    0x02, 0x00,    0x04, 0x00,                     0x00, 0x28,     0x01, 0x18,                                     //primary service declaration
    //< characteristic declaration:Service Changed
    13, 0x00,                    0x02, 0x00,    0x05, 0x00,                     0x03, 0x28,     0x20, 0x06, 0x00, 0x05, 0x2A,                   //characteristic declaration
...
void mesh_set_gap_name(const char *name)
{

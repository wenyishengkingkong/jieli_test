...
#ifdef CONFIG_UI_ENABLE
#if TCFG_LCD_TM9486X_ENABLE //客户屏
#define EMI_BAUD_DIV	EMI_BAUD_DIV2
#else
#define EMI_BAUD_DIV	EMI_BAUD_DIV7
#endif
...
#endif
#if TCFG_LCD_ILI9341_ENABLE || TCFG_LCD_ILI9481_ENABLE || TCFG_LCD_ILI9488_ENABLE

 ...
 *
 ****************************************/
#define QR_LEN 205  //这里我设置的版本号为5 长度计算为 21+(6-1)x4 = 21 + 16 = 37 长度要为 37的倍数
#define QR_URL "https://www.ai-alloy.com/standard/ble/ac67b25b58ee"
...
static void ui_demo_test(void *priv)
{
    ...
    uint8_t qr_version = 6; //设置当前二维码版本号
    uint8_t qr_max_version = 12;//当解析内容过于复杂的时候会自动升级版本号
    uint8_t qr_ecc_level = 4;//自动纠错等级

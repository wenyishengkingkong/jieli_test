...
VOID tx_application_define(void *first_unused_memory)
{
    ...
    thread_fork("GUIX Demo Thread", GX_SYSTEM_THREAD_PRIORITY + 1, 4096, 0, NULL, demo_thread_entry, 0);
}
...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    gx_studio_display_configure(DISPLAY_1, jl_graphics_driver_setup_24xrgb,

    ...
    while (*pc++ == KMC_RECORDSTART) {
        ...
        while (pc < nrec) {
            ...
            case KMC_TEST_LASTCODE:
                ...
                if (p1 != k->sc[k->cntsc - 2]) {
                    goto nextrecord;
                }
                break;
            case KMC_TEST_SHIFT:
                if ((k->keystate & (GKEYSTATE_SHIFT_L | GKEYSTATE_SHIFT_R))) {
                    break;
                }
                goto nextrecord;
            case KMC_TEST_NOSHIFT:
                ...
                goto nextrecord;
            case KMC_TEST_CTRL:
                if ((k->keystate & (GKEYSTATE_CTRL_L | GKEYSTATE_CTRL_R))) {
                    break;
                }
                goto nextrecord;
            case KMC_TEST_NOCTRL:
                ...
                goto nextrecord;
            case KMC_TEST_ALT:
                if ((k->keystate & (GKEYSTATE_ALT_L | GKEYSTATE_ALT_R))) {
                    break;
                }
                goto nextrecord;
            case KMC_TEST_NOALT:
            ...
            case KMC_TEST_NUMLOCK:
                if ((k->keystate & GKEYSTATE_NUMLOCK)) {
                    break;
                }
                goto nextrecord;

...
{
    if (src) {
        dst->a00 = src->a00 + src->a01 * sy;
        dst->a01 = src->a00 * sx + src->a01;
        dst->a02 = src->a02;
        dst->a10 = src->a10 + src->a11 * sy;
        dst->a11 = src->a10 * sx + src->a11;
        dst->a12 = src->a12;
        dst->a20 = src->a20 + src->a21 * sy;
        dst->a21 = src->a20 * sx + src->a21;
        dst->a22 = src->a22;
    } else {
        dst->a00 = 1.0;
        dst->a01 = sx;
...
void gmiscMatrixFloat2DApplyRotation(MatrixFloat2D *dst, const MatrixFloat2D *src, int angle)
{
    ...
    if (src) {
        dst->a00 = src->a00 * c - src->a01 * s;
        dst->a01 = src->a00 * s + src->a01 * c;
        dst->a02 = src->a02;
        dst->a10 = src->a10 * c - src->a11 * s;
        dst->a11 = src->a10 * s + src->a11 * c;
        dst->a12 = src->a12;
        dst->a20 = src->a20 * c - src->a21 * s;
        dst->a21 = src->a20 * s + src->a21 * c;
        dst->a22 = src->a22;
    } else {
        dst->a00 = c;
        dst->a01 = s;
...
{
    if (src) {
        dst->a00 = FIXEDMUL(sx, src->a00);
        dst->a01 = FIXEDMUL(sy, src->a01);
        dst->a02 = src->a02;
        dst->a10 = FIXEDMUL(sx, src->a10);
        dst->a11 = FIXEDMUL(sy, src->a11);
        dst->a12 = src->a12;
        dst->a20 = FIXEDMUL(sx, src->a20);
        dst->a21 = FIXEDMUL(sy, src->a21);
        dst->a22 = src->a22;
    } else {
        dst->a00 = sx;
        dst->a01 = 0;
...
{
    if (src) {
        dst->a00 = src->a00 + FIXEDMUL(sy, src->a01);
        dst->a01 = FIXEDMUL(sx, src->a00) + src->a01;
        dst->a02 = src->a02;
        dst->a10 = src->a10 + FIXEDMUL(sy, src->a11);
        dst->a11 = FIXEDMUL(sx, src->a10) + src->a11;
        dst->a12 = src->a12;
        dst->a20 = src->a20 + FIXEDMUL(sy, src->a21);
        dst->a21 = FIXEDMUL(sx, src->a20) + src->a21;
        dst->a22 = src->a22;
    } else {
        dst->a00 = FIXED(1);
        dst->a01 = sx;
...
void gmiscMatrixFixed2DApplyRotation(MatrixFixed2D *dst, const MatrixFixed2D *src, int angle)
{
    ...
    if (src) {
        dst->a00 = FIXEDMUL(c, src->a00) - FIXEDMUL(s, src->a01);
        dst->a01 = FIXEDMUL(s, src->a00) + FIXEDMUL(c, src->a01);
        dst->a02 = src->a02;
        dst->a10 = FIXEDMUL(c, src->a10) - FIXEDMUL(s, src->a11);
        dst->a11 = FIXEDMUL(s, src->a10) + FIXEDMUL(c, src->a11);
        dst->a12 = src->a12;
        dst->a20 = FIXEDMUL(c, src->a20) - FIXEDMUL(s, src->a21);
        dst->a21 = FIXEDMUL(s, src->a20) + FIXEDMUL(c, src->a21);
        dst->a22 = src->a22;
    } else {
        dst->a00 = c;
        dst->a01 = s;

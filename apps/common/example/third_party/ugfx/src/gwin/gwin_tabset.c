...
static gCoord TabpageBorderSize(GHandle gh)
{
    (void)gh;
    return 0;
}
...
static gCoord TabSetBorderSize(GHandle gh)
{
    return (gh->flags & GWIN_TABSET_BORDER) ? GTABSET_BORDER : 0;
}
static gCoord TabSetBorderTop(GHandle gh)
{

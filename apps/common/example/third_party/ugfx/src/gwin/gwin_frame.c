...
static gCoord FrameBorderSizeL(GHandle gh)
{
    (void)gh;
    return FRM_BORDER_L;
}
static gCoord FrameBorderSizeR(GHandle gh)
{
    (void)gh;
    return FRM_BORDER_R;
}
static gCoord FrameBorderSizeT(GHandle gh)
{
    (void)gh;
    return FRM_BORDER_T;
}
static gCoord FrameBorderSizeB(GHandle gh)
{
    (void)gh;
    return FRM_BORDER_B;
}

                  ...
                  jerryx_arg_optional_t opt_flag) /**< whether the argument is optional */
{
    ...
    return (jerryx_arg_t) {
        .func = func, .dest = (void *) dest, .extra_info = (uintptr_t) size
    };
} /* jerryx_arg_string */
                          ...
                          jerryx_arg_optional_t opt_flag) /**< whether the argument is optional */
{
    ...
    return (jerryx_arg_t) {
        .func = func, .dest = (void *) dest, .extra_info = (uintptr_t) info_p
    };
...
{
    return (jerryx_arg_t) {
        .func = func, .dest = dest, .extra_info = extra_info
    };
} /* jerryx_arg_custom */
                             ...
                             jerryx_arg_optional_t opt_flag) /**< whether the argument is optional */
{
    ...
    return (jerryx_arg_t) {
        .func = func, .dest = NULL, .extra_info = (uintptr_t) object_props
    };
                 ...
                 jerryx_arg_optional_t opt_flag) /**< whether the argument is optional */
{
    ...
    return (jerryx_arg_t) {
        .func = func, .dest = NULL, .extra_info = (uintptr_t) array_items_p
    };
} /* jerryx_arg_array */

...
void SkiaRenderPath::moveTo(float x, float y)
{
    m_Path.moveTo(x, y);
}
void SkiaRenderPath::lineTo(float x, float y)
{
    m_Path.lineTo(x, y);
}
...
void SkiaRenderPath::close()
{
    m_Path.close();
}

SkiaRenderPaint::SkiaRenderPaint()
{
...
void SkiaRenderPaint::color(unsigned int value)
{
    m_Paint.setColor(value);
}
void SkiaRenderPaint::thickness(float value)
{
    m_Paint.setStrokeWidth(value);
}
...
{
    return new SkiaRenderPath();
}
RenderPaint *makeRenderPaint()
{
    return new SkiaRenderPaint();
}
} // namespace rive
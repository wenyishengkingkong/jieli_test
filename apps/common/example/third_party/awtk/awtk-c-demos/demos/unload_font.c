...
static ret_t on_click(void *ctx, event_t *e)
{
    ...
    widget_set_text(widget, L"OK");

    widget_set_style_str(widget, "normal:font_name", "ap");
    widget_set_style_str(widget, "over:font_name", "ap");
    widget_set_style_str(widget, "pressed:font_name", "ap");
    widget_set_style_str(widget, "disable:font_name", "ap");

    font_manager_unload_font(font_manager(), "default", 0);
